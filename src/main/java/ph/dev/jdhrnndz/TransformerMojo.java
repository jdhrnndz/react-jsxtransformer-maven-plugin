...
/**
 * Goal which transforms React source codes.
 */
...
public class TransformerMojo extends AbstractMojo
{
    ...
    /**
     * Get source path array
     *
     * @return Source path array
     */
    public String[] getSourcePathArray()
    {
        return this.sourcePathArray;
    }
    ...
    public void execute() throws MojoExecutionException, MojoFailureException
    {
        ...
        String[] sourcePathArray = this.getSourcePathArray();
        ...
        for(int i=0; i<length; i++){
            try {
                this.logger.info(String.format("Transforming files in source path '%s' to destination path '%s'",
                    sourcePathArray[i], sourcePathArray[i]+"/build"));

                String jsxCommand = "";
                String[] commandArgs = this.buildCommand(jsxBin, sourcePathArray[i], sourcePathArray[i]+"/build");
     ...
     * @return JSX command
     */
    private String[] buildCommand(String scriptName, String sourcePath, String targetPath)
    {
